    ...
    <body>
                    ...
                    <div class='col-md-8 col-md-offset-2'>
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <form action="promokota" method="post" enctype="multipart/form-data">
                                    {{ csrf_field() }} 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="promo_category" class="form-control">
        ...
        <br>
         <div class="col-lg-12">
            ...
            <div class="panel-heading">Promo Kota</div>    
            <div class="panel-body">
            ...
            @foreach ($images as $image)
              ...
              <div class="gallery_product col-lg-3 col-md-3 col-sm-3 col-xs-12 filter hdpe" >
                ...
                <div class="desc">{{ $image->city }}</div>

                <div class='hoverbtn'>
              
                    <button type="submit">
                     <a href='{{route('api.deletekota', ['id' => $image->id]) }}'> <i class="fa fa-trash"></i> </a>
                    </button>
