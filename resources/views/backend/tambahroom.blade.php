                    ...
                    <div class='col-md-8 col-md-offset-2'>
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <form action="tambahroom" method="post" enctype="multipart/form-data">
                                    {{ csrf_field() }}
...
<!-- END UPLOAD MASAL -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="radio" name="breakfast"  value="N"><span>Tanpa Sarapan</span>
                                        <input type="radio" name="breakfast"  value="Y"><span>Dengan Sarapan</span>
                                    </div>

                                    <div class="form-group">
                                        <label>Pembatalan</label><br>
                                        <input type="radio" name="cancellation"  value="N"><span>Tidak Dikenakan Biaya</span>
                                        <input type="radio" name="cancellation"  value="Y"><span>Dikenakan Biaya</span>
                                    </div> 

                                    <div class="form-group">
                                        <label>Fasilitas</label><br>
                                        <textarea type="text" name="name_facilities" class="form-control" placeholder="Gunakan , (koma) sebagai pemisah. Ex: AC,TV"></textarea>
                                    </div>

                                    <div class="form-group">
                                        <label>Malam</label><br>
                                        <input class="form-control" type="text" name="duration" > <!-- - <input type="time" name="checkout2" > -->
                                    </div>  

                                    <div class="form-group">
                                        <label>Check-In</label><br>
                                        <input type="time" name="checkin" > - <input type="time" name="checkin2" >
                                    </div>

                                    <div class="form-group">
                                        <label>Check-Out</label><br>
                                        <input type="time" name="checkout" > <!-- - <input type="time" name="checkout2" > -->
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="date" name="checkoutdate" > <!-- - <input type="time" name="checkout2" > -->
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" name="special_facilities" class="form-control"></textarea>
                                    </div> 
