  ...
  <div class="upload #{className}">
    <div class="upload__wrap" id="media-list">
        ...
        <div class="upload__item">
            ...
            <a href="{{route('api.hapusGambar', ['gambarid' => $hotel->gambarid,'id' => $hotel->id]) }}" data-id="24663" class="upload__del"></a>
        </div>
        @endforeach
...
<!-- END UPLOAD MASAL -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="province" class="form-control" value="{{ $hotel->province }}">
                                    </div>  

                                    <div class="form-group">
                                        <label>Alamat</label>
                                        <textarea type="text" name="address" class="form-control" >{{ $hotel->address }}</textarea>
                                    </div> 
