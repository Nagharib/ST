...
$factory->define(App\Model\Perum::class, function (Faker\Generator $faker) {
$roles = App\Model\User::pluck('id')->toArray();
    return [
        'account_id'         => 1,
        'name'        => $faker->company,
        ...
        'created_by'        => $faker->randomElement($array = $roles),
        'updated_by'        => $faker->randomElement($array = $roles)
    ];
});

$factory->define(App\Model\Block::class, function (Faker\Generator $faker) {
$roles = App\Model\User::pluck('id')->toArray();
    return [
        'account_id'         => 1,
        'house_id'         => 1,
